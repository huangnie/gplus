...
if (document.getElementById('code')) {
    url = 'http://www.google.com/robots.txt?code=' + document.getElementById('code').value;
} else {
    url = 'http://www.google.com/robots.txt?error=access_denied';
}
var params = '?';
...
chrome.extension.sendMessage({msg: 'openpage', url: (redirect + params)}, function(response) {
